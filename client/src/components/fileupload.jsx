...
const FileUpload = ({ uploadedFile }) => {
  ...
  return (
    ...
    <TaggingProgress totalSentences={sentences.length} completedSentences={currentSentenceIndex + 1} />
      <div style={{ marginLeft: '50px', fontSize: '1em' }}>Selected Tag: {selectedTag}</div>
    </div>
      ...
      <LabelContainer onSelectTag={(tag, color) => {
        setSelectedTag(tag);
